        ...
        },
        {
            ...
            desc: [
                ...
                { main: "선로전환기 전환력 측정기", sub: [
                    ...
                    "센서 원시 신호를 실제 전환력 값으로 보정하고 장비 모델별 보정값을 DB로 관리",
                    "초당 100회 수집이 화면 표시를 막지 않도록 수신·저장·전송을 병렬 프로세스로 분리",
